...
impl StreamingState {
    ...
    pub(crate) async fn run_stream_loop(
        ...
        let pipeline_result = crate::pipeline::streaming::pipeline::run_pipeline(
            ctx,
            stream,
            sse_parser,
            &mut processor,
...
impl<'a> crate::pipeline::streaming::ChunkInterceptor for ChunkProcessor<'a> {
    async fn process_chunk(
        ...
        ctx: &StreamContext<'_>,
        stream: &mut crate::upstream::UpstreamBodyStream,
        event: crate::pipeline::streaming::ChunkEvent,
...
impl<'a> ChunkProcessor<'a> {
    ...
    async fn process_translated_format(
        ...
        let parsed = match target_format {
            crate::models::TargetFormat::Responses => crate::sse::parse_responses_sse_stream_line(
                line,
                &chunk_id,
                created,
                &model_name,

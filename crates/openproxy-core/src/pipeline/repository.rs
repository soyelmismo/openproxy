...
pub trait PipelineRepository: Send + Sync {
    ...
    fn get_account(&self, account_id: AccountId, master_key: &MasterKey) -> Result<Option<crate::accounts::Account>>;
    ...
    fn get_account_label(&self, account_id: AccountId, master_key: &MasterKey) -> Result<Option<String>>;

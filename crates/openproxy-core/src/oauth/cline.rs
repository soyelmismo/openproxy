...
mod tests {
    ...
    fn test_cline_auth_response_data_deserialization_and_ttl() {
        ...
        let data: ClineAuthResponseData =
            <ClineAuthResponseData as serde::Deserialize>::deserialize(&json_data).expect("deserialize valid json");
        ...
        let data_snake: ClineAuthResponseData =
            <ClineAuthResponseData as serde::Deserialize>::deserialize(&snake_json).expect("deserialize snake case");

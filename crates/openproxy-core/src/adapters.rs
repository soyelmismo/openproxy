...
impl KiroAdapter {
    ...
    fn hardcoded_models(&self) -> Vec<DiscoveredModel> {
        vec![
            DiscoveredModel {
                model_id: ModelId::new("auto-kiro"),
                display_name: Some("Auto (Kiro picks best model)".to_string()),
                target_format: TargetFormat::Openai,
                context_length: Some(200_000),
            ...
            DiscoveredModel {
                model_id: ModelId::new("claude-opus-4.8"),
            ...
            DiscoveredModel {
                model_id: ModelId::new("claude-opus-4.7"),
            ...
            DiscoveredModel {
                model_id: ModelId::new("claude-sonnet-5"),
            ...
            DiscoveredModel {
                model_id: ModelId::new("deepseek-3.2"),
                display_name: Some("DeepSeek V3.2".to_string()),
                target_format: TargetFormat::Openai,
                context_length: Some(200_000),
                max_output_tokens: Some(64_000),
                input_modalities: None,
            ...
            DiscoveredModel {
                model_id: ModelId::new("minimax-m2.5"),
                display_name: Some("MiniMax M2.5".to_string()),
                target_format: TargetFormat::Openai,
                context_length: Some(200_000),
                max_output_tokens: Some(64_000),
                input_modalities: None,
            ...
            DiscoveredModel {
                model_id: ModelId::new("minimax-m2.1"),
                display_name: Some("MiniMax M2.1".to_string()),
                target_format: TargetFormat::Openai,
                context_length: Some(200_000),
                max_output_tokens: Some(64_000),
                input_modalities: None,
            ...
            DiscoveredModel {
                model_id: ModelId::new("qwen3-coder-next"),
                display_name: Some("Qwen3 Coder Next".to_string()),
                target_format: TargetFormat::Openai,
                context_length: Some(200_000),
                max_output_tokens: Some(64_000),
                input_modalities: None,
...
impl ProviderAdapter for KiroAdapter {
    ...
    fn build_chat_url_for_account(
        ...
        if !account_label.is_empty() {
            if let Ok(re) = regex::Regex::new(r"[a-z]{2}-[a-z]+-[0-9]") {
                if let Some(m) = re.find(account_label) {

-- 000072_add_commandcodego_format.sql
-- Add 'commandcodego' to the providers.format and models.target_format CHECK constraints.
...
CREATE TABLE providers_new (
  ...
  CHECK (format IN ('openai', 'anthropic', 'mixed', 'gemini', 'responses', 'atomesus', 'commandcodego'))
);
...
UPDATE providers SET auth_type = 'bearer' WHERE id = 'commandcodego';
...
CREATE TABLE models_new (
  ...
  CHECK (target_format IN ('openai', 'anthropic', 'gemini', 'responses', 'atomesus', 'commandcodego'))
);

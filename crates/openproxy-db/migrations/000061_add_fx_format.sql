-- 000061_add_fx_format.sql
-- Add 'fx' to the providers.format and models.target_format CHECK constraints.
...
CREATE TABLE providers_new (
  ...
  CHECK (format IN ('openai', 'anthropic', 'mixed', 'gemini', 'responses', 'atomesus', 'fx'))
);
...
CREATE TABLE models_new (
  ...
  CHECK (target_format IN ('openai', 'anthropic', 'gemini', 'responses', 'atomesus', 'fx'))
);

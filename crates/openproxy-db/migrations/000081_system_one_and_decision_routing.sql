-- 000081_system_one_and_decision_routing.sql
-- Add 'systemone' to providers.format and models.target_format CHECK constraints,
-- and add decision routing support to combos and targets.
...
CREATE TABLE providers_new (
  ...
  rate_limit_scope       TEXT NOT NULL DEFAULT 'account',
  proxy_rotation_mode    TEXT NOT NULL DEFAULT 'global',
  favicon_base64         TEXT,
  ...
  CHECK (format IN ('openai', 'anthropic', 'mixed', 'gemini', 'responses', 'atomesus', 'commandcodego', 'systemone'))
);
...
INSERT INTO providers_new (
  ...
  rate_limit_scope, proxy_rotation_mode, favicon_base64, notif_keyword_only
)
SELECT
  id, name, base_url, auth_type, format,
  extra_headers_json, auto_activate_keyword, use_proxies,
...
-- Add decision routing support to combos and targets for System One models (Jev / Laya)
ALTER TABLE combos ADD COLUMN decision_model TEXT;
ALTER TABLE combos ADD COLUMN decision_timeout_ms INTEGER DEFAULT 100;
ALTER TABLE combo_targets ADD COLUMN description TEXT;

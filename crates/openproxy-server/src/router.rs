...
pub fn build_router(state: AppState) -> Router {
    ...
    // probe (`/admin/health`) and the OAuth browser callback
    // (`/admin/oauth/callback`) requires a `manage`-scope API
    ...
    let admin_routes = Router::new()
        ...
        .route(
            "/admin/config/idle-chunk-retryable",
        ...
        .route(
            "/admin/usage/monthly-by-provider",

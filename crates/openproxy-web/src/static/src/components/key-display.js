// components/key-display.js — render the one-shot "save this key"
...
function closeAndNavigateAndCloseModal(e) {
  if (e && e.target) {
...
export function showPlaintextKey(plaintext, metadata) {
  const html = `

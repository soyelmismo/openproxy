// components/model-custom-form.js — the "Add custom model" modal.
...
export function showCustomModelForm(providerId) {
...
export function closeCustomModelForm() {
  const m = document.getElementById("custom-model-modal");
  if (m) m.remove();
}
